    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('supplier.update') }}" id="myForm" >
                @csrf
                    <!-- use this to retrieve the id of the data to be fetched from the database -->
                <input type="hidden" name="id" value="{{ $supplier->id }}">
                    <!-- first we retrieve data for that specific field from the database using the $supplier var and we use the 'value to insert it into the input field' -->
            <div class="row mb-3">
