<!-- this page displays all the supplier details that have been added and modified with basic features like add, delete, edit suppliers -->
...
<div class="page-content">
    ...
    <div class="row">
        ...
        <h4 class="card-title">Supplier All Data </h4>
            <!-- data table that displays all supply    -->
